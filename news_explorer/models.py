...
class PersonManager(models.Manager):
    def articlesbyperson(self, personid):
        ...
        cursor.execute("select id,headline from news_explorer_article where id in "
                       "(select article_id from news_explorer_articlebyperson where person_id = %d)", [personid])
...
class LocationManager(models.Manager):
    def articlesbylocation(self,locationid):
        cursor = connection.cursor()
        cursor.execute("select id,headline from news_explorer_article where id in "
                       "(select article_id from news_explorer_articlebylocation where location_id = %d)", [locationid])
        rows = cursor.fetchall()
        return rows
...
class OrganizationManager(models.Manager):
    def articlebyorganization(self,organizationid):
        cursor = connection.cursor()
        cursor.execute("select id,headline from news_explorer_article where id in "
                       "(select article_id from news_explorer_articlebyorganization where organization_id = %d)", [organizationid])
        rows = cursor.fetchall()
        return rows
...
class PersonLocationManager(models.Manager):
    def articlesbypersonlocation(self,personid,locationid):
        cursor = connection.cursor()
        cursor.execute("select id,headline from news_explorer_article where id in (select p.article_id from news_explorer_articlebyperson p,news_explorer_articlebylocation l where person_id = %d and location_id = %d and p.article_id = l.article_id)", [personid, locationid])
        rows = cursor.fetchall()
        return rows
...
class PersonOrganizationManager(models.Manager):
    def articlesbypersonorganization(self,personid,organizationid):
        cursor = connection.cursor()
        cursor.execute("select id,headline from news_explorer_article where id in (select p.article_id from news_explorer_articlebyperson p, news_explorer_articlebyorganization o where person_id = %d and organization_id = %d and p.article_id = o.article_id)", [personid, organizationid])
        rows = cursor.fetchall()
        return rows
...
class LocationOrganizationManager(models.Manager):
    def articlesbylocationorganization(self, locationid, organizationid):
        cursor = connection.cursor()
        cursor.execute("select id,headline from news_explorer_article where id in (select p.article_id from news_explorer_articlebylocation p,news_explorer_articlebyorganization o where location_id = %d and organization_id = %d and p.article_id = o.article_id)", [locationid, organizationid])
        rows = cursor.fetchall()
        return rows
